# Experimental VST3 Companion / Cubase-Side Bridge

This legacy research area is excluded from the v2.0 public runtime and build. No prebuilt VST3 or Cubase extension binary is included.
